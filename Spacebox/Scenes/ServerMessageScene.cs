...
namespace Spacebox.Scenes
{
    ...
    public class ServerMessageScene : Scene, ISceneWithArgs<MenuScene2Params>
    {
        private CameraStatic player;
        ...
        public override void LoadContent()
        {
            ...
            AddChild(new Skybox(skyboxTexture));

            //skyBox.SetScale(300);
            player = AddChild(new CameraStatic(new Vector3(0, 0, 5)));
        ...
        public override void OnGUI()
        {
            ...
            CenteredText.SetColor(new System.Numerics.Vector4(1,0,0,1));
            CenteredText.Show();
            CenteredText.SetText(message);
            CenteredText.OnGUI();
            CenteredText.SetColor(new System.Numerics.Vector4(1, 1, 1, 1));
        }
