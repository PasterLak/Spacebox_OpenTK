...
public class ResourceProcessingBlock : InteractiveBlock
{
    ...
    {
        return [InputStorage, OutputStorage, FuelStorage];
    }
    public ItemSlot[] GetAllSlots()
    {
        return [InputStorage.GetSlot(0, 0), OutputStorage.GetSlot(0, 0), FuelStorage.GetSlot(0, 0)];
    }
